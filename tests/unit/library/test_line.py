...
from astrocompute.library.line import Line2D
...
def test_line2d_create_from_coordinates(
    x1: float, y1: float, x2: float, y2: float, expected: Line2D
):
    # Act
    actual = Line2D.from_coordinates(x1, y1, x2, y2)
